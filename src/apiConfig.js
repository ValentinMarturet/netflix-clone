...
export const tmdb = {
  ...
  apiKey: "?api_key=44a34c4ea6445906bf13da6a152d77f7",
  entity: {
...
export const tryGetPopularMovies = async (page = 1) => {
  try {
    const res = await axios(
      `https://api.themoviedb.org/3/movie/popular?api_key=44a34c4ea6445906bf13da6a152d77f7&language=en-US&page=${page}`
    );
